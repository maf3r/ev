...
<head>
<meta charset="utf-8">
<title>Dr. Eduardo Viteri - Instalaciones </title>
<!--=================================
Meta tags
=================================-->
...
<div class="offsetWrap">    
    <div class="offsetMaker"> 
		...
		<section class="latest-posts text-center">
    <div class="container">
          <h2 class="text-bold text-uppercase color-blue after-mid-l pb-25">
                   Ambientes de Atención Oftalmológica</h2>
        <p class="text-center">Dr. Eduardo Viteri</p>
        <div class="row mt-50">
            <div class="col-sm-4">
                <div class="posts">
                    <figure><img src="assets/demo-data/recepcion.jpg" alt="/"></figure>
                    <div class="info">
                        <div class="inner">
                          <h3 class="text-bold color-blue">Recepción</h3>
                        <h6 class="color-white text-bold">Área de secretaría y recepción de citas.</h6>     
						<a href="contacto.html" class="readmore">Contáctanos</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="posts">
                    <figure><img src="assets/demo-data/consultorio.jpg" alt="/"></figure>
                    <div class="info">
                        <div class="inner">
                        <h3 class="text-bold color-blue">Consultorio</h3>
                        <h6 class="color-white text-bold">Lugar y equipos adecuados para atender al paciente.</h6>
						<a href="contacto.html" class="readmore">Contáctanos</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-4">
                <div class="posts">
                    <figure><img src="assets/demo-data/qk.jpg" alt="/"></figure>
                    <div class="info">
                        <div class="inner">                        
                        <h3 class="text-bold color-blue">Quirófano</h3>
                        <h6 class="color-white text-bold">Ambiente apto para el área de cirugía.</h6>  
						<a href="contacto.html" class="readmore">Contáctanos</a>
                        </div>
                    </div>
                </div>
