...
Style Sheets
=================================-->
<link rel="icon" type="../image/png" href="ojo1.png"/>
...
<div class="offsetWrap">   
   <div class="offsetMaker">        
        <header class="bg-white doc-header">
            ...
            <nav id="sticktop">
            <div class="container">                
                    <a href="../../index.html" class="text-left logo"><img src="logo1.png" alt=""></a>
                    <ul class="socials">
        ...
        <section class="custom-slider no-pad">
            <div id="home-slider" class="xv_slider flexslider">
                <ul class="slides">
                    <li class="xv_slide" data-slideBg="url(slider1.jpg)">
                    ...
                    <li class="xv_slide" data-slideBg="url(slider2.jpg)">
                        <div class="flex-caption">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-offset-7 col-md-5 col-sm-6 col-sm-offset-6">
                    ...
                    <li class="xv_slide" data-slideBg="url(slider3.jpg)"></li>
                </ul>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <a class="titulo" href="../../preguntas-frecuentes.html"><div class="col-md-3 col-sm-6 service no-pad style1 bg-blue1">
                        <h6 class="text-uppercase text-bold after-left-s pb-45 mb-15"><img src="i1.png" class="pull-left" alt="/"><span class="pad">Preguntas Frecuentes<br> FAQ</span></h6>
                    ...
                    <a class="titulo" href="../../instalaciones.html"><div class="col-md-3 col-sm-6 service no-pad style2 bg-blue2">
                        <h6 class="text-uppercase text-bold after-left-s pb-45 mb-15"><img src="i2.png" class="pull-left" alt="/"><span class="pad">Infraestructura<br>Instalaciones</span></h6>
                    ...
                    <a class="titulo" href="../../equipos.html"><div class="col-md-3 col-sm-6 service no-pad style3 bg-blue3">
                        <h6 class="text-uppercase text-bold after-left-s pb-45 mb-15"><img src="i3.png" class="pull-left" alt="/"><span class="pad">Equipos de primera Tecnología</span></h6>
                    ...
                    <a class="titulo" href="../../contacto.html"><div class="col-md-3 col-sm-6 service no-pad style4 bg-blue4">
                        <h6 class="text-uppercase text-bold after-left-s pb-45 mb-15"><img src="i4.png" class="pull-left" alt="/"><span class="pad">Ubicación<br> Dirección</span></h6>
            ...
            <div class="container">
                ...
                <div class="row color-white">
                    <div class="col-sm-3 mt-50 no-pad doctor style1 bg-blue1 animated fadeInLeft">
                        <figure><img src="dm.jpg" alt="/"></figure>
                        <div class="info">
